            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-3">
                    <div class="gallery-card">
                        <img src="k1.jpg" alt="Gallery Image 1" class="card-img-top">
                    </div>
                </div>
                
                <div class="col-md-6 col-lg-3">
                    <div class="gallery-card">
                        <img src="laptop.jpg" alt="Gallery Image 2" class="card-img-top">
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="gallery-card">
                        <img src="k4.jpg" alt="Gallery Image 3" class="card-img-top">
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="gallery-card">
                        <img src="sunset.jpg" alt="Gallery Image 4" class="card-img-top">
                    </div>
